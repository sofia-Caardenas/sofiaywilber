...
public class Main {
    public static void main(String[] args) {
        ...
        "333410268");
//citamedico
        CitaMedicoo cm1= new CitaMedicoo(1, LocalDateTime.of(2024,Month.MAY,3,13,20,00), "gripa", "sofia", Estado.AGENDADA); 
        System.out.println("estado de la cita"+ cm1.getEstado());
        cm1.cancelarCita();
        System.out.println("estado de la cita despues de cancelar"+ cm1.getEstado());
        
        CitaMedicoo cm2= new CitaMedicoo(1, LocalDateTime.of(2024,Month.MAY,3,13,20,00), "escopolaminado","flores", Estado.AGENDADA); 
        //System.out.println("estado de la cita"+ cm1.getEstado());
...
CitaEnfermeroo ce1=new CitaEnfermeroo(1,LocalDateTime.of(2024, Month.APRIL, 3, 12, 40, 00), ProcedimientosEnfermeria.VACUNACION, "tatiana");
    ...
    CitaEnfermeroo ce2=new CitaEnfermeroo(2,LocalDateTime.of(2023, Month.APRIL, 3, 12, 40, 00), ProcedimientosEnfermeria.AMBULATORIOS, "MARICELA");
